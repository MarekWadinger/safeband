...
\begin{equation}
  q=P\{|x_a-\mu_{a \mid \boldsymbol{b}} |<3\sigma_{a \mid \boldsymbol{b}}\}=0.99735
  \text{.}\label{eq:q}
\end{equation}
...
\begin{equation}
  {\ui{x}{l}} = F((1 - P\{|x_a-\mu_{a \mid \boldsymbol{b}}|<3\sigma_{a \mid \boldsymbol{b}}\}); \mu_{a \mid \boldsymbol{b}}, \sigma_{a \mid \boldsymbol{b}}^2)^{-1}\text{,}\label{eq:thresh_low}
\end{equation}

for the lower limit, and

\begin{equation}
  {\ui{x}{u}} = F((P\{|x_a-\mu_{a \mid \boldsymbol{b}}|<3\sigma_{a \mid \boldsymbol{b}}\}); \mu_{a \mid \boldsymbol{b}}, \sigma_{a \mid \boldsymbol{b}}^2)^{-1}\text{,}\label{eq:thresh_high}
\end{equation}
...
For visual clarity, Figure \ref{fig:anomaly} illustrates the differences between point anomalies, collective anomalies, and change points.

\begin{figure}[htbp]
  \centering
  \resizebox{\linewidth}{!}{\includegraphics{figures/anomaly_definition.pdf}}
  \caption{Ilustration of sample scenarios of point anomaly (measurement with significant dissimilarity), collective anomaly (cluster of abnormal points), and change point (initial sequence of changed operation) detection.}
  \label{fig:anomaly}
\end{figure}
